export const utility2SubItems = [
  {
    ...
    thumbnails: [
      {
        id: 1,
        thumbImage: '/images/onyx.png',
        largeImage: '/images/onyx-large.jpg',
        color: 'Hitam'
      }
    ],
    specifications: [
  ...
  },
  {
    ...
    thumbnails: [
      {
        id: 1,
        thumbImage: '/images/multiline.png',
        largeImage: '/images/multiline-large.jpg',
        color: 'Abu-abu'
      }
    ],
    specifications: [
    ...
    technicalSpecs: [
      { label: 'Beban Lentur', value: '1250 N' },
      { label: 'Penyerapan Air', value: 'Maks. 9%' },
      { label: 'Ketebalan Cat', value: '110 Mikron' },
      { label: 'Warna Cat', value: 'Abu-abu Metalik' }
    ],
    installationNote: 'Pemasangan pola lurus'
  },
  {
    id: 'Slate',
    name: 'Slate',
    thumbnails: [
      {
        id: 1,
        thumbImage: '/images/slate.png',
        largeImage: '/images/slate-large.jpg',
        color: 'Abu-abu Gelap'
      }
    ],
    specifications: [
  ...
  },
  {
    ...
    thumbnails: [
      {
        id: 1,
        thumbImage: '/images/pine.png',
        largeImage: '/images/pine-large.jpg',
        color: 'Coklat'
      }
    ],
    specifications: [
  ...
  },
  {
    ...
    thumbnails: [
      {
        ...
        largeImage: '/images/classic-large.jpg',
        color: 'Merah'
      }
    ],
    specifications: [
    ...
    technicalSpecs: [
      ...
      { label: 'Ketebalan Cat', value: '80 Mikron' },
      { label: 'Warna Cat', value: 'Classic Red' }
    ],
    installationNote: 'Pemasangan pola tradisional'
  }
];

export const productsUt2Content = {
  'Neo Solar System': {
    name: 'NEO',
  ...
  'Concrete Block Variant': {
    ...
    thumbnails: [
      {
        id: 1,
        thumbImage: '/images/victoria.png',
        largeImage: '/images/victoria-large.jpg',
        color: 'Multi Warna'
      }
    ],
    specifications: [
    ...
    installationNote: '',
    type: utility2SubItems.map(item => ({
      name: item.name,
  ...
  'Utility Variant2': {
    ...
    thumbnails: [
      {
        id: 1,
        thumbImage: '/images/cw.png',
        largeImage: '/images/cw.png',
        color: 'Multi Warna'
      }
    ],
    tables: {
      wellComponents: {
        title: 'SPESIFIKASI',
        headers: ['', 'Ø Luar', 'Tebal', 'Berat'],
        rows: [
          ['Well Cover', '405 mm', '50 mm', '24 kg'],
          ['Well Frame LD', '1250 mm', '100 mm', '240 kg'],
          ['Well Frame HD', '1250 mm', '140 mm', '340 kg']
        ]
      },
      perviousWell: {
        title: '',
        headers: ['', 'Ø Dalam', 'Tebal binding', 'Ø Luar', 'Tinggi Efektif', 'Berat'],
        rows: [
          ['Pervious Well', '1000 mm', '125 mm', '1250 mm', '500 mm', '420 kg'],
          ['Pervious Well', '1000 mm', '125 mm', '1250 mm', '1000 mm', '840 kg']
        ]
      }
    }
  }
