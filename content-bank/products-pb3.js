...
export const kansteinWetprocessSubItems  = [
   {
  id: 'Kanstein Car Stopper 1',
  name: 'Kanstein Car Stopper 1',
  thumbnails: [
    {
      id: 1,
  ...
  {
  id: 'Kanstein Car Stopper 2',
  name: 'Kanstein Car Stopper 2',
  thumbnails: [
    {
      id: 2,
      thumbImage: '/images/Paving Block/Kanstein Wet/Kanstein Car Stopper.png',
...
export const kansteinDryprocessSubItems  = [
   {
  id: 'K.01.1',
  name: 'K.01.1',
  thumbnails: [
