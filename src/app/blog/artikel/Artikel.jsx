...
const artikelList = [
   {
    ...
    url: "/blog/artikel/detail-k",
    deskripsi: "Dalam setiap langkah kami, semangat kolaborasi adalah kunci. Dengan berpartner bersama brand-brand unggul yang memiliki reputasi kuat, kami mampu menghadirkan solusi yang lebih lengkap...",
    gambar: "/images/test-material1.jpg",
  },
   {
    id: 11,
    judul: "Efisisensi Produksi",
    tanggal: "10 Desember 2025",
    url: "/blog/artikel/detail-i",
    deskripsi: "Dalam industri konstruksi, efisiensi produksi adalah kunci untuk memenuhi kebutuhan volume besar tanpa mengorbankan kualitas. Dengan mesin HESS asal Jerman — yang dikenal memiliki...",
    gambar: "/images/test-material1.jpg",
  },
   {
    id: 10,
    ...
    tanggal: "10 Desember 2025",
    url: "/blog/artikel/detail-h",
    deskripsi: "Di balik setiap paving berkualitas, terdapat teknologi yang bekerja dengan akurat dan efisien. Mesin HESS dari Jerman menghadirkan inovasi dalam proses produksi paving block, mulai dari...",
    gambar: "/images/test-material1.jpg",
  },
   {
    id: 9,
    ...
    url: "/blog/artikel/detail-g",
    deskripsi: "Mutu produk merupakan pondasi utama yang membedakan Cisangkan sebagai produsen genteng beton dan paving block. Melalui sistem pengendalian yang terstandarisasi...",
    gambar: "/images/test-material1.jpg",
  },
   {
    id: 8,
    ...
    tanggal: "02 Desember 2025",
    url: "/blog/artikel/detail-l",
    deskripsi: "Di PT Cisangkan, kami percaya bahwa setiap genteng dan paving block memiliki cerita-cerita tentang kerja keras, ketelitian, dan komitmen terhadap...",
    gambar: "/images/QHSE-1.png",
  },
   {
    id: 7,
    judul: "Dukungan Teknis ",
