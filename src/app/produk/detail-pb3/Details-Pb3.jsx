  ...
  return (
    <div className="mt-[5.8rem] px-11 bg-white text-slate-800">
      ...
      <div className="relative w-full aspect-[1764/460] min-h-[180px] sm:min-h-[300px] overflow-hidden">
        ...
        <Image src="/images/Spanduk web Cisangkan.png" alt="Banner Detail Produk" width={1764} height={460} className="w-full h-full object-cover object-center" priority quality={100} sizes="100vw" />
      </div>
