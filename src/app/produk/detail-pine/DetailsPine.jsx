...
const NEO_PRODUCT = {
  ...
  thumbnails: [
    {
      id: 1,
      thumbImage: '/images/pines.png',
      largeImage: '/images/pines.png',
      color: 'Hitam Solid'
    },
    {
      id: 2,
...
export default function DetailsPine() {
...
<div className="relative aspect-square bg-white w-full flex items-center justify-center">
  <Image 
    ...
    height={500} // Tinggi gambar dalam piksel (rasio 1:1)
    style={{
      width: '100%',
      height: 'auto',
      objectFit: 'cover',
      aspectRatio: '1/1' // Memastikan rasio 1:1
    }}
...
<div className="mt-4">
  <div className="flex space-x-3">
    {NEO_PRODUCT.thumbnails.map((thumbnail) => (
      <div 
        key={thumbnail.id}
        className={`relative aspect-square w-16 h-16 rounded-xs overflow-hidden transition-all duration-200 cursor-pointer ${
      ...
      >
        <Image
          ...
          width={64}  // Lebar tetap 64px
          height={64} // Tinggi tetap 64px (rasio 1:1)
